...
from robustdepth.util.tracking_utils import log_parameter_dict
...
class ModelType(StringEnum):
    FULLY_FLEDGED_EFFNET_B0 = "FFEffNetB0"
    FULLY_FLEDGED_EFFNET_B5 = "FFEffNetB5"


def get_model_type_by_name(model_name):
    if model_name == "ff_effnet" or model_name == "ff_effnetb0":
        return ModelType.FULLY_FLEDGED_EFFNET_B0
    elif model_name == "ff_effnetb5":
        return ModelType.FULLY_FLEDGED_EFFNET_B5
    else:
