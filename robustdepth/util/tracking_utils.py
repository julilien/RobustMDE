...
from robustdepth.util.time_utils import get_time_str
...
def construct_model_checkpoint_callback(config, model_type, verbosity, test_run=False):
    save_dir = get_model_checkpoint_path(config)
    model_name = 'depthreg_%s_model.h5' % model_type
